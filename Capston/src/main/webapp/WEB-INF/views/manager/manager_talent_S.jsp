...
<body>
  ...
  <div class="container">
    ...
    <h3 id="notice_list_title" class="mt-4 mb-3">관리자 게시판-재능판매
...
<div class="search">
 ...
 $(function(){
  $('#searchBtn').click(function() {
   self.location = "manager_talent_S"
    ...
    <div class="card mb-4">
      <div class="card-body">
          <div class="col-lg-6">
            ...
            <p class="card-text"><div id="btn-place"><a href="/manager/manager_talent_S_view?n=${list.tals_Code}"  class="btn btn-primary">상세보기 &rarr;</a></div> </p> 
          </div>
      </div>
    </div>
...
<div>
 <ul>
  <c:if test="${pageMaker.prev}">
   <li><a href="manager_talent_S${pageMaker.makeQuery(pageMaker.startPage - 1)}">이전</a></li>
  </c:if> 
  
  <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
   <li><a href="manager_talent_S${pageMaker.makeQuery(idx)}">${idx}</a></li>
  </c:forEach>
    
  <c:if test="${pageMaker.next && pageMaker.endPage > 0}">
   <li><a href="manager_talent_S${pageMaker.makeQuery(pageMaker.endPage + 1)}">다음</a></li>
  </c:if> 
 </ul>
</div>
