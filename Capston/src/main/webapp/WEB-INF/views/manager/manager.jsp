...
<body>
  ...
  <div class="container">
    ...
    <h3 id="notice_list_title" class="mt-4 mb-3">관리자 게시판-공지사항
    <button id = "reg" onclick="location.href='/manager/manager_register'">등록</button>
    <a href="/manager/contact_member">회원관리</a><br>
    <a href="/manager/manager_talent_S">재능판매관리</a><br>
    <a href="/manager/manager_sell">물품판매관리</a><br>
    <a href="/manager/manager_faq">1:1문의관리</a><br>
      <small></small>
    </h3>
...
<c:forEach items="${list}" var="list">
	 ...
	 <div class="card-body">
	  <div class="row">
	   <div class="col-lg-6">
	    ...
	    <p class="card-text"><div id="btn-place"><a href="/manager/manager_view?n=${list.notice_Num}"  class="btn btn-primary">상세보기 &rarr;</a></div> </p>
	   </div>
	  </div>
	 </div>
	</div>
  ...
  <div id = "tradebtn">
    <button id = "reg" onclick="location.href='/manager/contact_register'">등록</button>
...
<div>
 <ul>
  <c:if test="${pageMaker.prev}">
   <li><a href="manager${pageMaker.makeQuery(pageMaker.startPage - 1)}">이전</a></li>
  </c:if> 
  
  <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
   <li><a href="manager${pageMaker.makeQuery(idx)}">${idx}</a></li>
  </c:forEach>
    
  <c:if test="${pageMaker.next && pageMaker.endPage > 0}">
   <li><a href="manager${pageMaker.makeQuery(pageMaker.endPage + 1)}">다음</a></li>
  </c:if> 
 </ul>
</div>
  <!-- Footer -->
